...
# Find JSON part of the string
            match = json_pattern.search(question_str)
            if match:
                json_part = match.group()
            try:
        # Load JSON part into a dictionary
                print(json_part)
                question = json.loads(json_part)
    ...
    def validate_question(self, question: dict) -> bool:
        ...
        for quest in self.question_bank:
            if quest["question"]==question["question"]:
                return False
        return True
        ##### YOUR CODE HERE #####
